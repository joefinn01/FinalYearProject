...
#if USE_GI
    float blendWeight = GetBlendWeight(hitPosW.xyz, l_RaytracePerFrameCB.VolumePosition, l_RaytracePerFrameCB.ProbeOffsets, l_RaytracePerFrameCB.ProbeSpacing, l_RaytracePerFrameCB.ProbeCounts);
